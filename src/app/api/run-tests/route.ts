...
const EVALUATOR_PROMPT = `You are a strict code compiler and test case evaluator.
Given the candidate's code in the specified language and a list of test cases, you must mentally execute the code against each test case.
...
export async function POST(req: Request) {
  try {
    const { code, problemId, language = "cpp" } = await req.json();
